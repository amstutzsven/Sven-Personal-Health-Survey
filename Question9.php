...
<?php include 'php/resultsurvey.php' ?>
  <div class="row">
    <div class="col-sm-8">
      <!-- CONTENT -->
      <h7>Frage 2</h7>
      ...
      <form action="question-6.php" method="post" onsubmit="return validateQuestion('single-choice-0', 'single-choice');">
        <div class="form-check">
            ...
            <label class="form-check-label" for="single-choice-0">
                Nein<?php include 'php/resultsurvey.php' ?>
        </div>
        <div class="form-check">
